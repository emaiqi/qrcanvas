...
// IE 9- does not support BArray
var BArray = typeof Uint8Array === 'undefined' ? Array : Uint8Array;
...
Edger.prototype = {
  ...
  prepare: function (canvas) {
     ...
     * 2 - edge of the image
     */
    var bgData = _this.data = new BArray(_this.total);
    /**
     ...
     * 2 - edge of the image
     */
    var pixelData = new BArray(_this.total);
...
QRCanvas.prototype.m_detectEdges = function () {
  ...
  if (logo.clearEdges) {
     ...
     * 1 - clear.
     */
    var transclude = _this.m_transclude = new BArray(count * count);
